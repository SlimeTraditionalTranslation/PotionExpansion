...
public class ResearchSetup {
    public static void setup(@Nonnull PotionExpansion plugin) {
        new Research(new NamespacedKey(plugin, "potions_sight"), 31001, "藥水視覺", 28)
        ...
        new Research(new NamespacedKey(plugin, "alchemic_station"), 31003, "煉金站", 15)
                .addItems(PotionItems.ALCHEMIC_STATION)
                .register();

        plugin.getLogger().info("載入研究!");
    }
}
